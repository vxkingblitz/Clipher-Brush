<template>
  <div class="paintingCardWrapper">
    {{ painting }}
    <img :src="'cipherbrush.ru' + painting.painting_colored" alt="painting" @error="handleImageError">
...
.paintingCard-bottom{
    height: 64px;
    background: #000000;
    background: linear-gradient(180deg,rgba(55, 55, 55, 0) 0%, rgb(28, 28, 28) 100%);
    position: absolute;
    bottom: 0;
    display: flex;
    align-items: end;
